...
async def about(ctx):
    ...
    embed.add_field(name="About", value="Coded by @Kubajsa#3871 in Python with <3. The GitHub repo for the bot is https://github.com/Kubajsa/discord.pyBot", inline= False)
